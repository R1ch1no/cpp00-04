...
/*   Updated: 2023/10/10 19:23:53 by rkurnava         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "ClapTrap contructor with a name called" << std::endl;
}

ClapTrap::ClapTrap(std::string name, int hp, int ep, int ad)
{
    std::cout << "ClapTrap contructor with all params called" << std::endl;
    this->name = name;
    this->hit_points = hp;
